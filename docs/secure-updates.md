...
python3 tools/verify_pilot_apk.py \
  ...
  --expected-package com.example.lockdowndpc \
  --expected-version-code 14 --expected-version-name 0.5.4 \
  ...
  --expected-apk-url https://github.com/ShalomMaman/android-lockdown-dpc/releases/download/pilot-v0.5.4/device-guard-pilot-v0.5.4.apk
```
