...
public final class KioskRecoveryPolicyTest {
    ...
    public void singleAppGetsTheHomeKeyOnceThisDpcOwnsHome() {
        assertTrue(KioskRecoveryPolicy.allowHomeKey(KioskMode.SINGLE_APP, true));
    }
    ...
    public void homeIsNeverEnabledWithoutTheKioskHomePreference() {
        ...
        assertFalse(KioskRecoveryPolicy.allowHomeKey(KioskMode.SINGLE_APP, false));
    }
    ...
    public void singleSiteAndManagedFilteringKeepTheMinimalFeatureSet() {
        ...
        assertFalse(KioskRecoveryPolicy.allowHomeKey(KioskMode.SINGLE_SITE, true));
        assertFalse(KioskRecoveryPolicy.allowHomeKey(KioskMode.OFF, true));
        assertFalse(KioskRecoveryPolicy.allowHomeKey(null, true));
    }
